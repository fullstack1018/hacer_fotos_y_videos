...
public class ActivityAnimUtil {
    ...
    L_0x004a:
        r9 = com.makeedit.photovideomaker.util.Utils.isLmpOrAbove();	 Catch:{ SecurityException -> 0x0082 }
    ...
    L_0x0066:
        r9 = com.makeedit.photovideomaker.util.Utils.isLmpMR1();	 Catch:{ SecurityException -> 0x0082 }
    ...
    L_0x008a:
        ...
        goto L_0x0064;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.makeedit.photovideomaker.util.ActivityAnimUtil.startActivity(android.view.View, android.content.Intent):boolean");
    }
}
