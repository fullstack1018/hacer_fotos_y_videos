...
import com.makeedit.hacerfotosyvideoseditar.TokanData.Glob;
import com.makeedit.hacerfotosyvideoseditar.service.CreateVideoService;
import com.makeedit.hacerfotosyvideoseditar.view.CircularFillableLoaders;
import com.makeedit.hacerfotosyvideoseditar.view.FreshDownloadView;
...
public class ProgressActivity extends AppCompatActivity implements OnProgressReceiver {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView((int) R.layout.activity_progress);
